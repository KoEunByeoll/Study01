...
<body bgcolor="f5ebd9";>
	...
	<table style="background: #f5ebd9;" align="center";>
		<tr>
			<td align="center"
				style="width: 100px; background: #fdf5ea; font-weight: bold; border-top-left-radius: 10px;
				margin-bottom: -3px;">학번</td>
			<td align="center"
				style="width: 100px; background: #ffffff; border-top-right-radius: 10px;">${member.sid}</td>
		</tr>
		<tr>
			<td align="center"
				style="width: 100px; background: #fdf5ea; font-weight: bold;">이름</td>
			<td align="center" style="width: 100px; background: #ffffff;">${member.name}</td>
		</tr>
		<tr>
			<td align="center"
				style="width: 100px; background: #fdf5ea; font-weight: bold;">전공</td>
			<td align="center" style="width: 100px; background: #ffffff;">${member.major}</td>
		</tr>
		<tr>
			<td align="center"
				style="width: 100px; background: #fdf5ea; font-weight: bold; border-bottom-left-radius: 10px;">과목</td>
			<td align="center"
				style="width: 100px; background: #ffffff; border-bottom-right-radius: 10px;">${member.subject}</td>
		</tr>
	</table>
	<div style="text-align: center;">
	<button type="button" onclick="location.href='${sid}'"
		...
		border-bottom-left-radius: 5px;">수정</button>
